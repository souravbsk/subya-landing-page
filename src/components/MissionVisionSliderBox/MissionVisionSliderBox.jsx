...
const MissionVisionSliderBox = ({title,pera}) => {
  return (
    ...
    >
      ...
      <h2 data-aos="fade-up" className="text-[#303030] font-extrabold tracking-tight font-anton  text-2xl md:text-5xl sm:text-4xl mb-3 md:mb-7">
        {title}
      </h2>
      <p data-aos="fade-up" className="lg:text-2xl md:text-2xl sm:text-base">
       {pera}
      </p>
