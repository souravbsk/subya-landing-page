    ...
    >
      <div className="lg:w-[50%] lg:py-20 md:py-16 py-6 pt-12 w-full">
        <div data-aos="fade-up" className="lg:px-4 md:px-16 px-5">
          <h2 className="text-[#303030] mb-3 md:mb-6 font-medium text-center font-anton leading-tight  md:text-3xl text-xl ">
            Empowering artisans to enter the world of <br className="md:block hidden" /> e-commerce through an{" "}
            <span className="text-[#7A5542] font-semibold">AI-powered App</span>
          </h2>
      ...
      <div
        ...
        className="lg:w-[50%]  md:pt-0  w-full "
      >
        <img
          className="lg:w-full md:w-10/12 mx-auto"
          src={solutionImg}
          alt=""
        />
      </div>
