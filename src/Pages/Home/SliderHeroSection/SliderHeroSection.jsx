      ...
      <div className="lg:w-1/2 flex lg:flex-col md:flex-row w-full ">
        <div className="flex-1 flex flex-col md:flex-row">
          <div className=" space-y-4 flex-1 flex items-center justify-center bg-[#F6F6F6]  ">
            <div className="py-6 lg:py-16 flex flex-col justify-center items-center  px-4  space-y-3">
        ...
        <div className="flex-1">
          <div
            ...
            className=" flex-1 bg-cover bg-center md:h-full h-full md:py-24 py-16 md:px-4 px-2 flex items-end justify-center"
          >
            <Link to="#">
